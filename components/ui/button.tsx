  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-250 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-[1.5px] border-[#232629] bg-primary-600/5 text-primary-400 hover:bg-primary-600/12 hover:text-primary-300 hover:-translate-y-0.5 active:translate-y-0 hover:shadow-[0_8px_16px_-4px_rgba(147,51,234,0.15)]",
        secondary:
          "bg-background-elevated border text-text-secondary hover:bg-background-hover hover:text-text-primary hover:-translate-y-0.5 active:translate-y-0 shadow-sm hover:shadow-md",
