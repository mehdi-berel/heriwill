        ...
        <CardContent className="p-8">
          <div className="flex items-start gap-6">
            <div className="flex-shrink-0">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center border border-pink-500/30">
                <Power className="h-8 w-8 text-pink-600 dark:text-pink-400" />
              </div>
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="px-2 py-0.5 text-xs font-semibold bg-pink-500/20 text-pink-700 dark:text-pink-300 rounded-full">
                  Ready
                </span>
              </div>
              ...
              <button
                ...
                disabled={saving}
                className="px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3 transform hover:scale-[1.02]"
              >
                <Power className="h-5 w-5" />
                Trigger Inheritance Plan Now
              </button>
              <div className="mt-4 p-3 bg-pink-50/50 dark:bg-pink-950/20 border border-pink-200/50 dark:border-pink-800/50 rounded-lg">
          ...
          <div className="bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full p-6 border border-gray-800">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={saving}
                className="flex-1 px-4 py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="flex-1 px-4 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {saving ? (
                  <>
