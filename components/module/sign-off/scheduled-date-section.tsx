      ...
      <CardContent className="p-4 md:p-8">
        <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
          <div className="flex-shrink-0 self-center md:self-start">
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 flex items-center justify-center border border-blue-500/30">
              <Calendar className="h-7 w-7 md:h-8 md:w-8 text-blue-600 dark:text-blue-400" />
            </div>
          </div>
          <div className="flex-1 w-full">
            <div className="flex items-center gap-2 mb-2 md:mb-3 flex-wrap">
              ...
              <span className="px-2.5 py-1 md:px-2 md:py-0.5 text-xs font-semibold bg-blue-500/20 text-blue-700 dark:text-blue-300 rounded-full">
                Active
              </span>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-100/80 to-indigo-100/80 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-xl p-4 md:p-5 border border-blue-200/50 dark:border-blue-800/50">
              <p className="text-xs font-semibold text-blue-900 dark:text-blue-200 mb-2 uppercase tracking-wider">
                Trigger Date & Time
              </p>
              <p className="text-lg md:text-2xl font-bold text-blue-600 dark:text-blue-400 mb-2 md:mb-3 break-words">
