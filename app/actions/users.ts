...
// Update Subscription - no-op for open source version without tiers
export async function updateSubscription(userId: string, subscriptionData: SubscriptionData) {
  // Subscription tiers removed for open source version
  return { id: userId }
}
...
// Get User Subscription Tier - returns 'free' for open source version
export async function getUserSubscriptionTier(userId: string): Promise<'free'> {
  // Subscription tiers removed for open source version
  return 'free'
}
